...
New-ItemProperty -Path "HKCU:\Software\Policies\Microsoft\Windows\WindowsAI" -Name DisableAIDataAnalysis -Type DWORD -Value 1  -ErrorAction SilentlyContinue -Force
Set-ItemProperty -Path "HKCU:\Software\Policies\Microsoft\Windows\WindowsAI" "DisableAIDataAnalysis" 1

New-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\Windows\WindowsAI" -Name DisableAIDataAnalysis -Type DWORD -Value 1  -ErrorAction SilentlyContinue -Force
...
New-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\Windows\WindowsCopilot" -Name TurnOffWindowsCopilot -Type DWORD -Value 1  -ErrorAction SilentlyContinue -Force
...
New-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\MicrosoftEdge\Main" -Name AllowPreLaunch -Type DWORD -Value 0  -ErrorAction SilentlyContinue -Force
Set-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\MicrosoftEdge\Main" "AllowPreLaunch" 0

New-ItemProperty -Path "HKLM:\Software\Policies\Microsoft\MicrosoftEdge\Main" -Name AllowTabPreLoading -Type DWORD -Value 0  -ErrorAction SilentlyContinue -Force
